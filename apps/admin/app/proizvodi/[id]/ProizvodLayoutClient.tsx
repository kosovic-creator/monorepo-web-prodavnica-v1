  ...
  const tabs = [
    {
      ...
      label: 'Pregled',
      icon: FaEye,
      isActive: pathname?.includes('/pregled') ?? false
    },
    {
      href: `/proizvodi/izmeni/${id}`,
      label: 'Izmeni',
      icon: FaEdit,
      isActive: pathname?.includes('/izmeni') ?? false
    },
    {
      href: `/proizvodi/${id}/historija`,
      label: 'Historija',
      icon: FaHistory,
      isActive: pathname?.includes('/historija') ?? false
    },
    {
      href: `/proizvodi/${id}/statistike`,
      label: 'Statistike',
      icon: FaChartLine,
      isActive: pathname?.includes('/statistike') ?? false
    }
  ];
